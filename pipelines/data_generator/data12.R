...
for( species in list_species ){ print(species)
  ...
  # print(i)
  if (
    file.exists(paste(path,"/Projet-NeGA/translational_selection/ExpOpti/",species,"_code_table.tab",sep=""))  &
    file.exists(paste(path,"/Projet-SplicedVariants/Analyses/",species,"/codon_usage_gene_fpkm.tab",sep="") )
  ){
