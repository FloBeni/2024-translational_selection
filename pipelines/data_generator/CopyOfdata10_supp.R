...
codon_usage = read.delim( paste("/home/fbenitiere/data/Projet-NeGA/translational_selection/daf_drosophila_simulans/processed/for_analysis/codon_usage_gene_fpkm.tab",sep="") )
...
# gene_data = read.delim("/home/fbenitiere/data/Projet-SplicedVariants/Annotations/Drosophila_simulans/formatted_data/gene.tab")
...
list_file = list.files(paste(path_data,"Projet-NeGA/translational_selection/daf_drosophila_simulans/processed/",subst_or_snp,"/",sep=""),
                       pattern=paste("count",count_file,"_codon",sep=""))
analyzable_codon_count = data.frame()
for (file in list_file){
  data_per_chr = read.delim(paste(path_data,"Projet-NeGA/translational_selection/daf_drosophila_simulans/processed/",subst_or_snp,"/" , file , sep=""))
...
data10 = data.frame()
###### gu
tRNA_optimal = read.delim(paste("/home/fbenitiere/data/Projet-NeGA/translational_selection/daf_drosophila_simulans/processed/for_analysis/","/decoding_table.tab.gz",sep=""))
...
write.table(data10,"data/data10_simulans_supp.tab",quote=F,row.names = F,sep="\t")
