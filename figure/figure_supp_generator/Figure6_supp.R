...
jpeg(paste(path_pannel,"p6A_supp.jpg",sep=""),  width = 10500/2/resolution,  5400/2/resolution,res=600/1.8/resolution)
print(pA)
dev.off()
...
imgA = load.image(paste(path_pannel,"p6A_supp.jpg",sep="") )

{
  pdf(file= paste(path_figure,"Figure6_supp.pdf",sep=""), width=9, height=5)
