...
jpeg(paste(path_pannel,"p1A_supptext.jpg",sep=""), width = 6000/4, height = 5000/4,res=800/4)
print(pA)
dev.off()
...
imgA = load.image(paste(path_pannel,"p1A_supptext.jpg",sep="") )

{
  pdf(file= paste(path_figure,"Figure1_supptext.pdf",sep=""), width=6, height=4)
