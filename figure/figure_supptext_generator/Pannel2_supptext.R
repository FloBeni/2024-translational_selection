...
jpeg(paste(path_pannel,"p2A_supptext.jpg",sep=""), width = 6000/4, height = 3000/4,res=600/4)
print(pA)
dev.off()
...
jpeg(paste(path_pannel,"p2B_supptext.jpg",sep=""), width = 6000/4, height = 3000/4,res=600/4)
print(pB)
dev.off()
...
imgB = load.image(paste(path_pannel,"p2B_supptext.jpg",sep="") )

{
  pdf(file= paste(path_figure,"Figure2_supptext.pdf",sep=""), width=4.5, height=4)
