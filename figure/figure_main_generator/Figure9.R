...
jpeg(paste(path_pannel,"p9E.jpg",sep=""),width = 4300/2, height = 3550/2,res=700/2)
print(pE)
dev.off()
...

{
  ...
  mtext("D",at=-100,adj=-1, side=2, line=1, font=2, cex=2.3,las=2)
  
  par(mar=c(0,4, 0, 7))
  plot(imgE, axes=FALSE)
  mtext("E",at=-100,adj=-1, side=2, line=1, font=2, cex=2.3,las=2)
  
  par(mar=c(0,0, 0, 1))
  plot(imgF, axes=FALSE)
  mtext("F",at=-100,adj=-1, side=2, line=1, font=2, cex=2.3,las=2)
  dev.off()
}
