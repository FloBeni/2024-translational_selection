...
pA =  ggplot(dt_graph,aes_string(y=ylabel,x=xlabel))  +
  ...
  scale_x_log10(breaks=c(0.05,0.1,0.5,1,5,10,100,1000,10000,50000),labels=c(0.05,0.1,0.5,1,5,10,100,1000,10000,50000)) + 
  xlab("Longevity (days log scale)")+ annotation_logticks(sides="b") 

pA

jpeg(paste(path_pannel,"F8pA.jpg",sep=""),width = 5200/2, height = 4000/2,res=700/2)
print(pA)
dev.off()
...
jpeg(paste(path_pannel,"F8pB.jpg",sep=""),width = 5200/2, height = 4000/2,res=700/2)
print(pB)
dev.off()
...
{
  pdf(file= paste(path_figure,"Figure8_bis.pdf",sep=""), width=10, height=4)
