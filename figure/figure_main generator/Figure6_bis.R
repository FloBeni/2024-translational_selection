...
pA = ggplot(data1,aes(y=expressed_overused_background_WC_duet_ambiguous*100,x=clade_group,fill=clade_group,label=species))  +
...
jpeg(paste(path_pannel,"F6pA.jpg",sep=""), width = 5500/1, height = 3000/1,res=500/1)
print(pA)
dev.off()
...
{
  pdf(file= paste(path_figure,"Figure6_bis.pdf",sep=""), width=7, height=7)
  ...
  mtext("B",at=200,adj=-5, side=2, line=1, font=2, cex=1.7,las=2)
  dev.off()
}
