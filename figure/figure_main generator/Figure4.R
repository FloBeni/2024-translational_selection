...
jpeg(paste(path_pannel,"p4B.jpg",sep=""),  width = 11000/2,  5500/2,res=900/1.8)
print(p4B)
dev.off()
...

{
  ...
  xhuman=450
  yhuman=-300
  rasterImage(human,xleft=0+xhuman, ybottom=350/.9-yhuman, xright=190/.9+xhuman, ytop=0-yhuman)
  par(mar=c(0, 1, 1, 0))
